...
class SunriseDataSourceTest {
    private val expected = SunriseInfo(
        ...
        geometry = Geometry(
            type = "Point", coordinates = listOf(10.0f, 60.0f)
        ),
        `when` = When(
            interval = listOf("2024-03-06T23:20:00Z", "2024-03-07T23:30:00Z")
        ),
        properties = Properties(
            body = "Sun", solarnoon = Solarnoon(
                visible = true, time = "2024-03-07T11:30+00:00", discCentreElevation = 0.0
            ), sunrise = Sunrise(
                azimuth = 98.73, time = "2024-03-07T05:59+00:00"
            ), sunset = Sunset(
                azimuth = 261.63, time = "2024-03-07T17:03+00:00"
            ), solarmidnight = Solarmidnight(
                visible = false, time = "2024-03-06T23:31+00:00", discCentreElevation = 0.0
            )
        )
    )
    ...
    fun checkReturntypeFetchSunriseData() = runBlocking {
        ...
        val result =
            source.fetchSunriseData("https://api.met.no/weatherapi/sunrise/3.0/edr/collections/sun/position?coords=POINT%2810%2060%29&datetime=2024-03-07")
